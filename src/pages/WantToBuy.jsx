...
import WantToBuyContent from '../components/account/WantToBuyContent'
      ...
      <div className="mt-1">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-[#1A1C1E] font-medium">Want to Buy</span>
          </nav>
        </div>
      </div>

      {/* Account layout with sidebar + Want to Buy content */}
      <AccountLayout
        sidebarProps={{
          user,
