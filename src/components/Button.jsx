...
const Button = ({
  ...
  const variants = {
    ...
    verification: 'flex h-10 px-6 py-[8px] px-[24px] justify-center items-center gap-2 rounded bg-[#2C2C2C] text-white font-normal transition-colors hover:bg-[#FFB703]/90',
    edit: 'px-4 py-2 rounded-[48px] bg-gray-200 text-[#1A1C1E] font-medium text-sm transition-colors hover:bg-gray-300'
  }
